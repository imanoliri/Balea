...
The **Alcohol by Volume (ABV)** can be calculated using the formula: _ABV(%)=(76.08 * (OG - FG) / (1.775 - OG)) * (FG / 79.4)_. The **Original Gravity (OG)** itself can be estimated based on the total sugar content of the ingredients in relation to the amount of water used: _OG=1 + Total_sugar(kg) / (Total_water(kg)*2.5)_.
